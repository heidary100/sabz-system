...
export function AlertTitle({
  ...
  return (
    <Headless.DialogTitle
      ...
      className={clsx(
        className,
        'text-center text-base/6 font-semibold text-balance text-zinc-950 sm:text-start sm:text-sm/6 sm:text-wrap dark:text-white'
      )}
    />
  )
}
...
export function AlertDescription({
  ...
  return (
    <Headless.Description
      as={Text}
      {...props}
      className={clsx(className, 'mt-2 text-center text-pretty sm:text-start')}
    />
  )
}
