...
export class ListWarehousesQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Search term matched against warehouse name or code.',
    maxLength: 100,
  })
  @IsOptional()
  @Transform(({ value }) => (typeof value === 'string' ? value.trim() : value))
  @IsString({ message: 'search باید رشته باشد.' })
  @MaxLength(100, { message: 'search باید حداکثر ۱۰۰ کاراکتر باشد.' })
  search?: string;
  ...
  @IsOptional()
  @IsEnum(WarehouseStatus, { message: 'status معتبر نیست.' })
